	...
	<body>
		...
		<form class="w3-col w3-margin-top w3-card-4 w3-padding" encType="multipart/form-data"
			...
			<div class="w3-col w3-margin-top">
				...
				<div class="w3-col m9 pdl20 w3-label w3-margin-left" style="padding-left: 5px;"> ${SID}</div>
			</div>
			<div class="w3-col w3-margin-top">
				<label class="w3-col m2 w3-right-align w3-label">Title : </label>
				<input type="text" name="title" id="title" 
						class="w3-col m9 w3-input pdl20 w3-margin-left" placeholder="제목을 입력하세요!">
			</div>
			<div class="w3-col w3-margin-top">
			...
			<div class="w3-col w3-margin-top w3-margin-bottom ">
				...
				<div class="w3-col m9 pdl20 filefr">
					<textarea name="body" id="body" 
							class="w3-col w3-input w3-margin-left w3-border" placeholder="내용을 입력하세요!" rows="10" style=""></textarea>
				</div>
			</div>
		...
		<div class="w3-col w3-margin-top w3-card-4 w3-margin-bottom">
			...
			<div class="w3-third w3-button w3-blue w3-hover-deep-blue wbtn">작 성</div>
		</div>
	</div>
	</body>
</html>