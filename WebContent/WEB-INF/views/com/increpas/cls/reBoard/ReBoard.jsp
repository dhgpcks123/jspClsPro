				...
				<span class="w3-button w3-display-topright" id="mcbtn">&times;</span>
					...
					<div class="w3-col">
						<div class="w3-col inblock avtbox100 pdr10">
							<img src="/cls/img/avatar/${AVTIMG}" class="avtimg100 w3-border" id="${SID}">
						</div>
						<form class="w3-rest" id="frm" name="frm">
							...
							<div class="w3-col pdh1 mt5">
								...
								<span class="w3-col m2 w3-right w3-button w3-small w3-orange w3-hover-deep-orange btnBox" id="wrbtn">글 등 록</span>
							</div>
						</form>
					</div>
				</div>
							...
							<div class="w3-col">
								...
								<div class="w3-rest">
									...
									<div class="w3-col w3-padding w3-left-align w3-display-container">
										<div class="w3-col" style="font-size: 9pt;">${data.body}</div>
